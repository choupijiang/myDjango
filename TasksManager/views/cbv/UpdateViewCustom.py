...
class UpdateViewCustom(UpdateView):
    template_name = 'UpdateViewCustom.html'
    # In this line, we define the template that will be used for all the CBVs that extend the UpdateViewCustom class. This
    # template_name field can still be changed if we need it.
    url_name=""
    # This line is used to create the url_name property. This
    # property will help us to define the name of the current URL. In
    # this way, we can add the link in the action attribute of the form.
